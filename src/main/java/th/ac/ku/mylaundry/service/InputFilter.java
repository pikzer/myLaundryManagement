...
public class InputFilter implements ChangeListener {
    ...
    public void changed(ObservableValue observableValue, Object oldValue, Object newValue) {
        StringProperty value = new SimpleStringProperty((String) newValue);
        ...
        if (!box.isShowing()) {
            ...
            if (!((String) newValue).isEmpty() && box.isFocused()) {
                box.show();
            }
        }
